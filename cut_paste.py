...
class CutPaste(object):
    ...
    def __call__(self, img):
        ...
        org_img = img.copy()
        org_img.paste(patch, insert_box)
        
        return org_img
    

class CutPasteSamll(object):
    def __init__(self, area_ratio=[0.0005, 0.001], aspect_ratio=0.85, colorJitter=0.1):
        self.area_ratio = area_ratio
        self.aspect_ratio = aspect_ratio
    ...
    def __call__(self, img):
        ...
        for i in range(8):
            ratio_area = random.uniform(self.area_ratio[0], self.area_ratio[1]) * w * h
            aspect = random.uniform(self.aspect_ratio, self.aspect_ratio + 0.5)
...
class CutPasteLarge(object):
    def __init__(self, area_ratio=[0.01, 0.02], aspect_ratio=0.3, colorJitter=0.1):
        self.area_ratio = area_ratio
        self.aspect_ratio = aspect_ratio
